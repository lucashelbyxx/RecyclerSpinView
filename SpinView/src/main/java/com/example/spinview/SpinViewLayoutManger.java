...
public class SpinViewLayoutManger extends RecyclerView.LayoutManager {
    ...
    private SpinViewLayoutManger(boolean isFlat, boolean isGreyItem,
...
//        cm.setSaturation(0.9f);
    ...
    /**
     * 该方法主要用于{@link RecyclerSpinView#getChildDrawingOrder(int, int)}判断中间位置
    ...
    /**
     * 获取中间位置
     * <p>Note:该方法主要用于{@link RecyclerSpinView#getChildDrawingOrder(int, int)}判断中间位置
    ...
    static class Builder {
        ...
        public SpinViewLayoutManger build() {
            return new SpinViewLayoutManger(isFlat, isGreyItem,
