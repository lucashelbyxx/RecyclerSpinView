...
public class RecyclerSpinView extends RecyclerView {
    /**
     * 按下的X轴坐标
     */
     ...
     * 布局器构建者
     */
    private SpinViewLayoutManger.Builder mManagerBuilder;

    public RecyclerSpinView(Context context) {
        super(context);
        init();
    }

    public RecyclerSpinView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public RecyclerSpinView(Context context, @Nullable AttributeSet attrs, int defStyle) {
    ...
    private void createManageBuilder() {
        if (mManagerBuilder == null) {
            mManagerBuilder = new SpinViewLayoutManger.Builder();
        }
    }
    ...
    public void setLayoutManager(LayoutManager layout) {
        if (!(layout instanceof SpinViewLayoutManger)) {
     ...
     */
    public SpinViewLayoutManger getCoverFlowLayout() {
        return ((SpinViewLayoutManger)getLayoutManager());
    }
     ...
     * @param l 监听接口
     */
    public void setOnItemSelectedListener(SpinViewLayoutManger.OnSelected l) {
